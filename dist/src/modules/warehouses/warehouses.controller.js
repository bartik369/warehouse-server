...
const warehouseDto_1 = require("./dtos/warehouseDto");
...
let WarehousesController = class WarehousesController {
    ...
    async createWarehouse(warehouseDto) {
        const warehouse = await this.warehousesService.createWarehouse(warehouseDto);
        return {
            message: constants_1.warehouseCreated,
            warehouse,
        };
    }
    ...
    async updateWarehouse(id, warehouseDto) {
        const updatedWarehouse = await this.warehousesService.updateWarehouse(id, warehouseDto);
        return {
            message: constants_1.warehouseUpdated,
            updatedWarehouse,
        };
    }
};
...
__decorate([
    (0, common_2.Get)('assignable/:locationId'),
    __param(0, (0, common_1.Param)('locationId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WarehousesController.prototype, "getAssignable", null);
__decorate([
    (0, common_2.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [warehouseDto_1.WarehouseDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, warehouseDto_1.WarehouseDto]),
    __metadata("design:returntype", Promise)
